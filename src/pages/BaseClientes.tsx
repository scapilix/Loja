...
import { Filter, X, Search, Instagram, Mail, Phone, MapPin, ShoppingBag, Clock, Calendar, ChevronsRight } from 'lucide-react';
              ...
              {displayedCustomers.map((customer, index) => (
                <tr 
                  ...
                  <td className="px-4 py-2">
                    <div className="flex items-center gap-1.5 text-slate-800 dark:text-slate-200 font-bold max-w-[200px] truncate" title={customer.address}>
